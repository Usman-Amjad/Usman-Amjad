          ...
          <div className="flex items-center justify-between w-full lg:flex-col">
            ...
            <div className="w-1/2 flex flex-col items-center self-center lg:w-full lg:text-center">
              ...
              <p className="my-4 text-base font-medium md:text-sm sm:text-xs">
                As a skilled python developer, I am dedicated to turning ideas
                into innovative desktop applications. Explore my latest projects
                and articles, showcasing my expertise in python and database
                management.
              </p>
              <div className="flex items-center self-start mt-2 lg:self-center">
                <Link
                  href="/Resume-Usman-Amjad.pdf"
                  target={"_blank"}
                ...
                <Link
                  href="mailto:uamjad06@gmail.com"
                  target={"_blank"}
